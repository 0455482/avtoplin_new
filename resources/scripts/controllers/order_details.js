...
app.controller('orderDetailsCtrl', function ($scope, $filter, $rootScope, $http, $location, $log, $route, GetDataService, updateURL, parseGetParams) {
    //init params
	var getParams = {};
    $scope.orderDetails = {};
	...
	$scope.initData = function() {
        ...
        GetDataService.post('order_details/init', {
           order_id: getParams.order_id
            ...
            $("#statusNarocila .cs-select .cs-placeholder").append($scope.orderDetails.name);
            $("#gorivo .cs-select .cs-placeholder").append($scope.orderDetails.fuel);
            $scope.loading = false;
        });
    ...
    $scope.changeDate = function() {
        $scope.urediBtn = $scope.isDisabled ? 'Uredi' : 'Nazaj';
